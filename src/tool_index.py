...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "calc_vessel_thickness_api510": "Calculate minimum required thickness (t_min), remaining life, and next inspection interval for refinery pressure vessels per API 510 and ASME Sec VIII Div 1 UG-27. Use for vessel integrity and corrosion assessment.",
    "calc_pipe_thickness_api570": "Calculate minimum required thickness and remaining life for process piping per API 570 and ASME B31.3 Barlow's formula. Use for piping retirement evaluations.",
    "calc_pump_hydraulics": "Evaluate refinery pump hydraulic performance, Darcy-Weisbach head loss, and NPSH cavitation margin per API 610. Use for centrifugal pump sizing and cavitation analysis.",
    "calc_heat_exchanger_duty": "Calculate heat exchanger thermal duty (Q), Log Mean Temperature Difference (LMTD), and required heat transfer area per TEMA.",
    "optimize_crude_blend": "Optimize crude oil blending ratios for distillation throughput to meet sulfur and API gravity specifications.",
    "inspect_pid_drawing": "Inspect and parse P&ID drawing text or image for ISA-5.1 instrumentation loops, valves, and safety relief discrepancies.",
    "verify_audit_log": "Verify cryptographic integrity and Merkle root hash of the air-gapped refinery audit trail.",
    "plan_refinery_turnaround": "Generate comprehensive refinery turnaround / shutdown execution package with phased schedule, blinding list, and OISD-105 safety controls.",
}
